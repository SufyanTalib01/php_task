...
<?php
    ...
    $sql = "INSERT INTO `newcontactus` (`sno`, `fname`, `lname`, `email`, `concern`, `datetime`) VALUES (NULL, '$fname', '$lname', '$email', '$desc', CURRENT_TIMESTAMP)";
...
<form action="/tutorial28(2).php" method="post">
